...
| `[BUSINESS_CONTEXT.md](../BUSINESS_CONTEXT.md)` | Product scope, risks (infra section may be outdated) |
| `[docs/TODO-ROADMAP.md](TODO-ROADMAP.md)`       | Backlog, pricing notes, ops reminders                |
| `[docs/NEXT_SESSION.md](NEXT_SESSION.md)`       | Shorter handoff duplicate of roadmap + pricing       |
| `[docs/anki/](anki/)`                           | Anki / `.apkg` technical reference                   |
